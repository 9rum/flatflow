// Adapted from https://github.com/abseil/abseil-cpp/blob/20240116.0/absl/container/btree_map.h
...
// btree_map<>
//
// A `btree_map<K, V>` is an ordered associative container of
...
// `std::less<K>`.
//
// A `btree_map<K, V>` uses a default allocator of
...
class btree_map
 ...
 public:
  ...
  // * Default constructor
  //
  //   btree_map<int, std::string> map1;
  //
  // * Initializer list constructor
  //
  //   btree_map<int, std::string> map2 = {{1, "huey"}, {2, "dewey"}, {3, "louie"}};
  //
  // * Copy constructor
  //
  //   btree_map<int, std::string> map3(map2);
  //
  // * Copy assignment operator
  //
  //   btree_map<int, std::string> map4;
  //   map4 = map3;
  //
  // * Move constructor
  //
  //   // Move is guaranteed efficient
  //   btree_map<int, std::string> map5(std::move(map4));
  //
  // * Move assignment operator
  //
  //   // May be efficient if allocators are compatible
  //   btree_map<int, std::string> map6;
  //   map6 = std::move(map5);
  //
  // * Range constructor
  //
...
// swap(btree_map<>, btree_map<>)
//
// Swaps the contents of two `btree_map` containers.
template <typename K, typename V, typename C, typename A, int S>
ABSL_ATTRIBUTE_ALWAYS_INLINE void swap(btree_map<K, V, C, A, S> &map, btree_map<K, V, C, A, S> &other) {
  map.swap(other);
}
...
template <typename K, typename V, typename C, typename A, int S>
ABSL_ATTRIBUTE_ALWAYS_INLINE void swap(btree_multimap<K, V, C, A, S> &map, btree_multimap<K, V, C, A, S> &other) {
  map.swap(other);
}
