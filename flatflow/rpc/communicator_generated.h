...
struct InitRequest FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  const ::flatbuffers::Vector<uint16_t> *sizes() const {
    return GetPointer<const ::flatbuffers::Vector<uint16_t> *>(VT_SIZES);
  }
...
struct InitRequestBuilder {
  ...
  void add_sizes(::flatbuffers::Offset<::flatbuffers::Vector<uint16_t>> sizes) {
...
inline ::flatbuffers::Offset<InitRequest> CreateInitRequest(
    ...
    uint64_t rank = 0,
    uint64_t seed = 0,
    ::flatbuffers::Offset<::flatbuffers::Vector<uint16_t>> sizes = 0,
...
inline ::flatbuffers::Offset<InitRequest> CreateInitRequestDirect(
    ...
    bool heterogeneous = false,
    bool use_flat_shuffle = false) {
  auto sizes__ = sizes ? _fbb.CreateVector<uint16_t>(*sizes) : 0;
...
struct BroadcastRequest FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  const ::flatbuffers::Vector<double> *costs() const {
    return GetPointer<const ::flatbuffers::Vector<double> *>(VT_COSTS);
  }
  bool Verify(::flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
...
struct BroadcastRequestBuilder {
  ...
  void add_costs(::flatbuffers::Offset<::flatbuffers::Vector<double>> costs) {
    fbb_.AddOffset(BroadcastRequest::VT_COSTS, costs);
  }
  explicit BroadcastRequestBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
...
inline ::flatbuffers::Offset<BroadcastRequest> CreateBroadcastRequest(
    ...
    uint64_t epoch = 0,
    uint64_t rank = 0,
    ::flatbuffers::Offset<::flatbuffers::Vector<double>> costs = 0) {
...
inline ::flatbuffers::Offset<BroadcastRequest> CreateBroadcastRequestDirect(
  ...
  auto costs__ = costs ? _fbb.CreateVector<double>(*costs) : 0;
...
struct BroadcastResponse FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  const ::flatbuffers::Vector<uint64_t> *indices() const {
    return GetPointer<const ::flatbuffers::Vector<uint64_t> *>(VT_INDICES);
  }
...
struct BroadcastResponseBuilder {
  ...
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_indices(::flatbuffers::Offset<::flatbuffers::Vector<uint64_t>> indices) {
  ...
  explicit BroadcastResponseBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
...
inline ::flatbuffers::Offset<BroadcastResponse> CreateBroadcastResponse(
    ::flatbuffers::FlatBufferBuilder &_fbb,
    ::flatbuffers::Offset<::flatbuffers::Vector<uint64_t>> indices = 0,
...
inline ::flatbuffers::Offset<BroadcastResponse> CreateBroadcastResponseDirect(
    ...
    bool converged = false) {
  auto indices__ = indices ? _fbb.CreateVector<uint64_t>(*indices) : 0;
