...
//
// NOTE: `Key` does not necessarily have to be `Numerical`. Key types other than
// `Numerical` may also be supported by adding `Compare` to the template
// arguments, just like associative containers.
