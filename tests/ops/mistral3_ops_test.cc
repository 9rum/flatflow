...
TEST_F(SymbolicTraceTest, Mistral3) {
  ...
  const auto trace =
      flatflow::symbolic_trace(graph);  // 16609 s0^2 + 2107858564 s0

  EXPECT_EQ(trace(0), 0);
  EXPECT_EQ(trace(1), 2107875173);
  EXPECT_EQ(trace(1024), 2175862968320);
  EXPECT_EQ(trace(2048), 4386557534208);
}
