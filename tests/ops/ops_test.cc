...
TEST_F(SymbolicTraceTest, Llama31) {
  ...
  const auto expr = flatflow::symbolic_trace(graph);  // 1284 s1^2 + 67178363 s1

  EXPECT_EQ(expr(0), 0);
  EXPECT_EQ(expr(1), 67179647);
  EXPECT_EQ(expr(1024), 70137015296);
  EXPECT_EQ(expr(2048), 142966773760);
}
